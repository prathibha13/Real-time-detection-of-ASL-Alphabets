...
model.load_state_dict(torch.load('C:\\Users\\prathibha k s\\ASL\\output\\model.pth'))
print(model)
print('Model loaded')
...
out = cv2.VideoWriter('C:\\Users\\prathibha k s\\ASL\\output\\asl.mp4', cv2.VideoWriter_fourcc(*'mp4v'), 30, (frame_width,frame_height))
